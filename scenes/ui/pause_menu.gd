...
func _unhandled_input(event: InputEvent) -> void:
	if event.is_action_pressed("pause"):
		close()
		#set the input as handled so nothing else tries to handle it
...
func on_options_pressed():
	...
	options_scene_instance.back_pressed\
	.connect(on_options_back_pressed.bind(options_scene_instance))
